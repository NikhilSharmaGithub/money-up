...
val FLAGS: Map<String, List<GlyphPart>> = mapOf(
    "\ud83c\udde7\ud83c\uddf7" to listOf(
        ...
        GlyphPart("M1.75 16a14.25 14.25 0 1 0 28.5 0a14.25 14.25 0 1 0 -28.5 0Z", fill = null, stroke = 0xFF000000, strokeWidth = 1.5f),
    ),
    "\ud83c\udde8\ud83c\udde6" to listOf(
    ...
    "\ud83c\uddee\ud83c\uddf3" to listOf(
        ...
        GlyphPart("M0 0L0 0", fill = null, stroke = 0xFF000080, strokeWidth = 0.72f),
        GlyphPart("M0 0L0 0", fill = null, stroke = 0xFF000080, strokeWidth = 0.72f),
        GlyphPart("M0 0L0 0", fill = null, stroke = 0xFF000080, strokeWidth = 0.72f),
        GlyphPart("M0 0L0 0", fill = null, stroke = 0xFF000080, strokeWidth = 0.72f),
        GlyphPart("M0 0L0 0", fill = null, stroke = 0xFF000080, strokeWidth = 0.72f),
